...
GROUP_NAME="${GROUP_NAME:-g1_bilinear_sr_pretrain_feature_only_4096_100m}"
RUN_PREFIX="${RUN_PREFIX:-g1_bilinear_sr_pretrain_feature_only_4096_100m}"
