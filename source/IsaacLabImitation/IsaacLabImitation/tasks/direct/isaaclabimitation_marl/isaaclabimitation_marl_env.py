...
from .isaaclabimitation_marl_env_cfg import IsaaclabimitationMarlEnvCfg


class IsaaclabimitationMarlEnv(DirectMARLEnv):
    cfg: IsaaclabimitationMarlEnvCfg

    def __init__(self, cfg: IsaaclabimitationMarlEnvCfg, render_mode: str | None = None, **kwargs):
