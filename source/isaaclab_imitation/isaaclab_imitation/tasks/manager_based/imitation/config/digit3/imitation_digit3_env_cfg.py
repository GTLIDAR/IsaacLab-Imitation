...
from isaaclab_assets.robots.digit import DIGITV3_CFG
...
@configclass
class ImitationDigit3EnvCfg(ImitationLearningEnvCfg):
    # MDP settings
    observations = Digit3ObservationCfg()
    rewards = Digit3RewardsCfg()  # type: ignore
    ...
    # Reference joint names for the robot from the reference qpos order (this is the order of Digit3 in loco-mujoco)
